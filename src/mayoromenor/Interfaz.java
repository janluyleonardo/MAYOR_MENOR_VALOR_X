...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (n1>100){
            resultado.setText("El numero Ingresado es mayor a 100");
        }
        if (n1<100){
            resultado.setText("El numero Ingresado es Menor a 100");
        }
        if (n1==100){
            resultado.setText("El numero Ingresado es Igual a 100");
        }
